...
test('from composer returns null if could not find php package', function (string $path) {
...
test('from composer returns null if file does not exist', function () {
...
test('from composer returns null if could not find a matched version', function () {
